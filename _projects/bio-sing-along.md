...
img: # add a thumbnail, e.g. assets/img/bio-sing-along.jpg
importance: 1
...
<!-- Add photos or a video below once available, e.g.:
<div class="row justify-content-center mt-4">
  <div class="col-12 col-lg-11">
    {% include video.liquid path="https://www.youtube.com/embed/XXXXXXXXXXX" class="img-fluid rounded z-depth-1 w-100" %}
  </div>
</div>
-->
